...
// Install UI widgets
export function installWidgets(app: ComfyAppLike, rebased: ComfyRebase) {
  ...
  const dropImageButton = new ComfyButton({
    ...
    classList: 'comfyui-button primary',
    action: () => {
      rebased.dropModal.openImageDropModal();
    },
  });
